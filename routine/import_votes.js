...
var importDateSpeedch= async (datestart,name) =>{
    ...
    return new Promise((resolve,rej)=>{
        ...
        var url = "https://lysayit.g0v.ronny.tw/api/vote/" +
         encodeURIComponent(name) +"?limit=1&page=1";
        console.log(url);
        request(url,
...
var importDateAllVote = async (date) =>{
...
(async ()=>{
    ...
    await importDateAllVote( ( item && item.meetingDate ) || "2020-05-01");
    knex.destroy();
})();
